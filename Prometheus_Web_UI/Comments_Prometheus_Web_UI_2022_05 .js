...
{/*  ====  Java Script  ====
    ...
    *** №2 создания ф-и (FUNCTION EXPRESSION) функциональное выражение. 
    ...
    et count = function (num1 = 1, num2 = 2, num3 = 3) {
            let result = num1 + num2 + num3;
            console.log(result)
    };
    count(1);
    ...
    *** Поиск элемента на странице
        ...
        (function() {
            let id = document.geElementById("_id");  - получили ссылку на элемент
        ...
        По классу
        (function() {
            let classArr = document.geElementByClassName("_class");  - получили ссылки на все элементы с этим классом(массив)
        ...
        (function() {
            let tagArr = document.geElementByTagName("p");  - получили ссылки на все элементы с этим тегом(массив)
